...
const getPlatformId = a => (a = WAProto_1.proto.DeviceProps.PlatformType[a.toUpperCase()]) ? a.toString() : "1";
exports.getPlatformId = getPlatformId;

exports.BufferJSON = {
    replacer: (a, b) =>
        Buffer.isBuffer(b) || b instanceof Uint8Array || "Buffer" === (null === b || void 0 === b ? void 0 : b.type)
            ? { type: "Buffer", data: Buffer.from((null === b || void 0 === b ? void 0 : b.data) || b).toString("base64") }
            : b,
    reviver: (a, b) =>
        "object" !== typeof b || !b || !0 !== b.buffer && "Buffer" !== b.type
            ? b
            : (a = b.data || b.value, "string" === typeof a ? Buffer.from(a, "base64") : Buffer.from(a || []))
};

const getKeyAuthor = (a, b = "me") =>
    ((null === a || void 0 === a ? 0 : a.fromMe) ? b : (null === a || void 0 === a ? void 0 : a.participant) || (null === a || void 0 === a ? void 0 : a.remoteJid)) || "";
exports.getKeyAuthor = getKeyAuthor;

const writeRandomPadMax16 = a => {
    const b = require('crypto').randomBytes(1);
    b[0] &= 15;
    b[0] || (b[0] = 15);
    return Buffer.concat([a, Buffer.alloc(b[0], b[0])]);
};
exports.writeRandomPadMax16 = writeRandomPadMax16;

const unpadRandomMax16 = a => {
    a = new Uint8Array(a);
    if (0 === a.length) throw Error("unpadPkcs7 given empty bytes");
    var b = a[a.length - 1];
    if (b > a.length) throw Error(`unpad given ${a.length} bytes, but pad is ${b}`);
